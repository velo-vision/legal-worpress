  ...
  <div class="valign-wrapper">
    ...
    <div class="col l12 m12 s12 valign">
      ...
      <div class="col l1 m1 offset-m5 s2 offset-s4 center prev">
        ...
        <a href="servicios-3.php"><img src="<?php bloginfo('template_url'); ?>/images/servicios/prev.png" title="Prev" alt="Legal Nest"></a>

      </div>

      <div class="col l1 m1 s2 center prev hide-on-large-only">

        <a href="servicios-1.php"><img src="<?php bloginfo('template_url'); ?>/images/servicios/next.png" title="Prev" alt="Legal Nest"></a>
          ...
          <div class="col l4 m4 s12 servicios center">
            ...
            <div class="col l10 offset-l1 m12 s12">
              ...
              <div class="col l12 m12 s12">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/servicios/constitutiva.png" title="Constitutiva" alt="Legal Nest">
          ...
          <div class="col l4 m4 s12 servicios center">
            ...
            <div class="col l10 offset-l1 m12 s12">
              ...
              <div class="col l12 m12 s12">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/servicios/contratos.png" title="Contratos" alt="Legal Nest">
          ...
          <div class="col l4 m4 s12 servicios center">
            ...
            <div class="col l10 offset-l1 m12 s12">
              ...
              <div class="col l12 m12 s12">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/servicios/marca.png" title="Marca" alt="Legal Nest">
          ...
          <div class="col l4 m4 s12 servicios center">
            ...
            <div class="col l10 offset-l1 m12 s12">
              ...
              <div class="col l12 m12 s12">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/servicios/nda.png" title="NDA" alt="Legal Nest">
          ...
          <div class="col l4 m4 s12 servicios center">
            ...
            <div class="col l10 offset-l1 m12 s12">
              ...
              <div class="col l12 m12 s12">
                ...
                <img src="<?php  bloginfo('template_url'); ?>/images/servicios/digital.png" title="Digitalización Documentos" alt="Legal Nest">
          ...
          <div class="col l4 m4 s12 servicios center">
            ...
            <div class="col l10 offset-l1 m12 s12">
              ...
              <div class="col l12 m12 s12">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/servicios/in-house.png" title="In-House Counsel" alt="Legal Nest">
      ...
      <div class="col l1 prev center hide-on-med-only hide-on-small-only">
        ...
        <a href="servicios-1.php"><img src="<?php bloginfo('template_url'); ?>/images/servicios/next.png" title="Next" alt="Legal Nest"></a>
      ...
      <div class="col l12 m12 s12">
        ...
        <div class="col l2 offset-l5 m2 offset-m5 s4 offset-s4 bottom-50">
          ...
          <a href="<?php echo site_url("?page_id=14");?>"><p class="contacto-paquete">Contratar</p></a>
