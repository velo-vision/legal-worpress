      ...
      <div class="col l12 m12 s12 nomargin">
        ...
        <div class="col l3 m6 s12 top-somos top-somos">
          <div class="col l7 offset-l2 m8 offset-m2 s8 offset-s2">
            <img width="100%" src="<?php bloginfo('template_url'); ?>/images/recursos/abogados.png" title="Firma tradicional de abogados" alt="LegalNest">
          </div>
        </div>
      ...
      <div class="col l10 offset-l1 m12 s12 no-somos center top-50">
        <div class="col l4 m4 s8 offset-s2 hvr-bob">
          <a href="<?php echo site_url("?page_id=55");?>" class="animsition-link"> <!-- que no 1 -->
            <img src="<?php bloginfo('template_url'); ?>/images/recursos/firma-tradicional.png" title="Firma Tradicional" alt="Legla Nest">
          </a>
        </div>
        ...
        <div class="col l2 m4 offset-m2 s8 offset-s2 hvr-float-shadow top-somos top-small">
          <a href="<?php echo site_url("?page_id=74");?>" class="animsition-link"> <!-- que no 4 -->
            ...
            <p class="nomargin">Servicios de</p>
            <p class="nomargin"> consultoría </p>
            <p class="nomargin"> integral</p>
          </a>
        </div>
        <div class="col l2 m4 s8 offset-s2 hvr-float-shadow top-somos top-small">
          <a href="<?php echo site_url("?page_id=70");?>" class="animsition-link"> <!-- que no 5 -->
            <img src="<?php bloginfo('template_url'); ?>/images/recursos/esquema.png" title="Esquema Piramidal" alt="LegalNest">
            <p class="nomargin">Adiós al</p>
