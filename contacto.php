    ...
    <div class="valign-wrapper">
      <div class="col l12 s12 nomargin valign">
        ...
        <div id="contact_body">
          ...
          <a class="btn-floating btn-large right boton-enviar" ><input type="image" src="images/recursos/avion-contacto.png" id="submit_btn" value="Submit" style="margin-top: 9%;"></a>
          </div>
        </div>
