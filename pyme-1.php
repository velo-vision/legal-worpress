    ...
    <div class="col l12 s12 valign">
      ...
      <div class="col l10 offset-l1 m12 s12 top-50">
        ...
        <div class="col l12 s12 top-30">
          <div class="col l4 offset-l2 m4 offset-m2 s12 startup-paquete">
            <div class="col l3 s12 center startup-img">
          ...
          <div class="col l4 offset-l1 m4 offset-m1 s12 startup-paquete">
            <div class="col l3 s12 center-middle startup-img">
