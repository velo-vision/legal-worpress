    ...
    <div class="col l12 s12 valign">
      <div class="col l12 nomargin">
          ...
          <div class="col l12 m12 nomargin">
            <div class="col l3 m5 cuadro-1">
              <div class="col l10 offset-l1 m12 s12">
                <p>Hoy, contratar servicios legales significa solucionar un problema en específico, por lo que <strong>las
            ...
            <div class="col l3 m5 s12 cuadro-2">
              <div class="col l12 s12">
                <p>Es difícil prevenir estos problemas o proponer soluciones funcionales sin conocer tus
        ...
        <div class="col l3 m8 offset-m2 s12">
          ...
          <div class="col l12 s12 center top-30 mobile">
            <img src="<?php bloginfo('template_url'); ?>/images/recursos/que-no3.png" title="Que no somos 2" alt="Legal Nest">
          </div>
        </div>
      </div>
      <div class="col l10 offset-l1 m12 s8 offset-s2 no-somos center top-50">
        <div class="col l2 offset-l1 m3 offset-m1 s10 offset-s1 one hvr-float-shadow">
          <a href="<?php echo site_url("?page_id=55");?>" class="animsition-link">
        ...
        <div class="col l2 m4 s12 hvr-float-shadow top-small">
          <a href="<?php echo site_url("?page_id=66");?>" class="animsition-link">
        ...
        <div class="col l3 m4 s12 hvr-bob top-small">
          ...
          <a href="<?php echo site_url("?page_id=54");?>" class="animsition-link"><!-- que no 3 -->
            ...
            <img width="180px;" src="<?php bloginfo('template_url'); ?>/images/recursos/aliado2.png" title="Aliado Comercial" alt="Legal Nest">
