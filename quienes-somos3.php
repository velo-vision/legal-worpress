...
<div class="row nomargin bg-quienes">
  <div class="valign-wrapper">
    <div class="col l12 s12 valign">
      ...
      <div class="col l6 m10 offset-m1 top-100">
      ...
      <div class="col l12 s12 top-30">
        <div class="col l4 offset-l4 s12 center">
          <a href="quienes-somos2.php" class="animsition-link">
            <img style="margin:0 10px" width="50px" src="images/recursos/prev.png" alt="Legal Nest">
          </a>
          <a href="quienes-somos4.php" class="animsition-link">
...
<script>
  window.onload=function(){
    setTimeout(function() {
      console.log("lupita")
      location.href="quienes-somos4.php";
    },7000);
  }
</script>
