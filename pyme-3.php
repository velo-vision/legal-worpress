    ...
    <div class="col l12 s12 valign">
      <div class="col l12 s12 nomargin">
        <div class="col l3 m4 s12 paquete-startup center">
          <p class="nomargin top-10"><strong>PAQUETE</strong> <span>3</span></p>
        ...
        <div class="col l2 m2 s4 paquete-numero top-50 center">
          <a href="pyme-3.php">
            <p class="nomargin top-10">paquete</p>
            <p class="nomargin top-10"><span>3</span></p>
          </a>
        </div>
      </div>
      <div class="col l12 m12 s12 top-50">
        <div class="col l12 s12 nomargin">
          ...
          <div class="col l3 m3 s12 startup-paquete nomargin">
            ...
            <div class="col l9 s12">
              <div class="col l12 s12 center-middle">
                <p><strong>CONTRATO A, B, C, D</strong></p>
                <p>
        ...
        <div class="col l12 s12 top-50">
          <div class="col l3 m3 s12 startup-paquete nomargin">
            ...
            <div class="col l9 s12">
              <div class="col l12 s12 center-middle">
                <p><strong>apertura de libros</strong></p>
                <p>
                  Éste es un requisito que viene
                  en la Ley, te ayudamos a
                  estarsiem
                  pre en orden.
                </p>
              </div>
          ...
          <div class="col l3 m3 s12 startup-paquete">
            <div class="col l3 s12 center startup-img">
              <img src="images/pyme/titulos.png" title="Apertura de Libros" alt="Legal Nest">
            </div>
            <div class="col l9 s12">
              <div class="col l12 s12 center-middle">
