    ...
    <div class="row nomargin bg-quienes bg-quienes23">
        <div class="col l12 s12 ">
          ...
          <div class="col s10 offset-l1 content-slide">
            ...
            <div><h3><img style="width:100px!important;margin:20px auto;" src="images/legal/6.png" alt=""></h3>
              ...
              <div><h3><img style="width:100px!important;margin:20px auto;" src="images/legal/5.png" alt=""></h3>
              ...
              <div><h3><img style="width:100px!important;margin:20px auto;" src="images/legal/1.png" alt=""></h3>
                  <p class="nomargin top-30">El 75% de los startups</p>
                  <p class="nomargin">cierran al segundo año</p>
                  <p class="nomargin">de operación.</p>
              </div>
              <div><h3><img style="width:100px!important;margin:20px auto;" src="images/legal/cobramos.png" alt=""></h3>
                  <p class="nomargin top-30">Cobramos por ejecución,</p>
                  <p class="nomargin">no por hora</p>
              </div>          
              <div>
                <h3><img style="width:100px!important;margin:20px auto;" src="images/legal/2.png" alt=""></h3>
              ...
              <div>
                <h3><img style="width:100px!important;margin:20px auto;" src="images/legal/3.png" alt=""></h3>
              ...
              <div><h3><img style="width:100px!important;margin:20px auto;" src="images/legal/costos_claros.png" alt=""></h3>
